...
**TKTK: Describe ferguson-project here.**
...
```
cd ferguson-project
mkvirtualenv --no-site-packages ferguson-project
...
```
* * * * * ubuntu bash /home/ubuntu/apps/ferguson_project/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|ferguson-project|tweet|`location`||||
|ferguson-project|facebook|`location`||||
|ferguson-project|email|`location`||||
|ferguson-project|new-comment||||
|ferguson-project|open-share-discuss||||
|ferguson-project|close-share-discuss||||
|ferguson-project|summary-copied||||
|ferguson-project|featured-tweet-action|`action`||``tweet_url``|
|ferguson-project|featured-facebook-action|`action`||``post_url``|
