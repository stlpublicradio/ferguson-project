...
PROJECT_FILENAME = 'ferguson_project'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_URL = 'https://docs.google.com/spreadsheet/ccc?key=0Ahk37aM1t_GZdEJBV2pFSlZaT1FwTHBfVkdseDNudHc'
